...
interface INewEnumValue extends IEnumValue {
  isNew?: boolean;
}
...
export class EditEnumerationComponent implements OnInit {
  ...
  public onSubmit(): void {
    ...
    this.enumerationService.updateEnumeration(this._enumeration.key, this._enumeration)
      .subscribe(
        value => {
          this.enumeration = value;
          for (const property of this.enumeration.values) {
            (property as INewEnumValue).isNew = undefined;
          }
